...
ADDON     =  xbmc.translatePath(os.path.join('special://home/addons/plugin.program.imperiotugawizard',''))
...
if xbmc.getCondVisibility('system.platform.ios') or xbmc.getCondVisibility('system.platform.osx'):
	LoginServer = "http://www.imperiotuga/login.php"
	...
	BetaOne = "http://imperiotuga.comxa.com/wizard/BetaOne.xml"
	BetaTwo = "http://imperiotuga.comxa.com/wizard/BetaTwo.xml"
else:
	LoginServer = "http://www.imperiotuga/login.php"
	JarvisOne = "http://imperiotuga.comxa.com/wizard/JarvisOne.xml"
	JarvisTwo = "http://imperiotuga.comxa.com/wizard/JarvisTwo.xml"
...
if os.path.exists(NOTICE):
	if os.path.exists(CHECKVERSION):
		dialog.ok(AddonTitle,'[COLOR lime]This build is provided FREE OF CHARGE![/COLOR]','[COLOR white]If you were charged please inform us at:[/COLOR]','[COLOR yellow]Imperio Tuga[/COLOR]')
		os.remove(NOTICE)
