...
AddonTitle="[COLOR cyan]Imperio Tuga[/COLOR] [COLOR lightsteelblue]Wizard[/COLOR]"
...
if xbmc.getCondVisibility('system.platform.ios') or xbmc.getCondVisibility('system.platform.osx'):
	...
	Addons = "http://raw.github.com/imperiotuga/imperiotuga.repository/master/addons.xml/README.xml"
	...
	BetaWiz = "http://imperiotuga.comxa.com/wizard/BetaWiz.xml"
	BetaVIPWiz = "http://imperiotuga.comxa.com/wizard/BetaVIPWiz.xml"
	BetaVIP = "http://imperiotuga.comxa.com/wizard/BetaVIP.xml"
	BetaKeys = "http://imperiotuga.comxa.com/wizard/BetaKeys.xml"
	SpeedTest = "http://imperiotuga.comxa.com/wizard/SpeedTest.xml"
	AdvancedSettings = "http://imperiotuga.comxa.com/wizard/AdvancedSettings.xml"
	JarvisOne = "http://imperiotuga.comxa.com/wizard/JarvisOne.xml"
	JarvisTwo = "http://imperiotuga.comxa.com/wizard/JarvisTwo.xml"
	KryptonOne = "http://imperiotuga.comxa.com/wizard/KryptonOne.xml"
	KryptonTwo = "http://imperiotuga.comxa.com/wizard/KryptonTwo.xml"
	BASEURL = "http://imperiotuga.comxa.com/"
else:
	Repo = "http://raw.github.com/imperiotuga/imperiotuga.repository/master/addons.xml"
	Addons = "http://imperiotuga.comxa.com/wizard/README.xml"
	Website = "http://imperiotuga.comxa.com/"
	Forum = "http://imperiotuga.comxa.com/"
	Community = "https://www.facebook.com/"
	JarvisWiz = "http://imperiotuga.comxa.com/wizard/JarvisWiz.xml"
...
def INDEX():
  ...
  #else:
  #  plugintools.message(AddonTitle,"Invalid Login: Check Details Or Register On Our Forum","[COLOR yellow]http://www.imperiotuga.comxa.com[/COLOR]")
...
def NotCompatible():
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok(AddonTitle, "[B][COLOR powderblue]Important Notice: [/COLOR][/B]",'[COLOR cyan]Imperio Tuga Builds are not compatabile with any Kodi versions before 16 Jarvis.','Imperio Tuga Builds will NOT work with Frodo, Gotham and Isengard versions of Kodi.[/COLOR]')
