...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'plugin.program.imperiotugawizard')
...
MaintTitle="Imperio Tuga Wizard"
...
BASEURL = "http://www/imnperiotuga.com"
H = 'http://'
skin         =  xbmc.getSkinDir()
EXCLUDES     = ['Database','cache','temp','backupdir','plugin.program.imperiotugawizard','imperiotuga.repository',"kodi.log","kodi.log.old","spmc.log","spmc.log.old"]
...
zip = 'special://home/addons/plugin.program.imperiotugawizard'
urlbase      =  'None'
